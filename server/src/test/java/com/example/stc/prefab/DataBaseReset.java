...
public class DataBaseReset {
    ...
    public void resetDataBase() {
        ...
        saveEntrust(entrustJson, "p20190610010104", users.get(1).getUserID(), "Game软件"); // CUSB
        saveEntrust(entrustJson, "p20190610010105", users.get(1).getUserID(), "LittleBird软件"); // CUSB
        // 清空其他数据库
